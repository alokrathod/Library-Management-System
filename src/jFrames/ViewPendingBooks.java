 ...
 * @author Lenovo
 */
public class ViewPendingBooks extends javax.swing.JFrame {
    ...
    public void setPendingBookDetailsToTable() {
        try {
            ...
            String sql = "select ibd.id, bd.book_name, sd.name as student_name, ibd.issue_date, ibd.due_date, ibd.status from issue_book_details as ibd join book_details bd on ibd.book_id = bd.book_id join student_details sd on ibd.student_id = sd.student_id where ibd.status = ?";
    ...
    private void initComponents() {
        ...
        jLabel1.setText("View Pending Books");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 40, -1, -1));

        jPanel5.setBackground(new java.awt.Color(255, 51, 51));
        jPanel5.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());
        jPanel1.add(jPanel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 95, 380, 5));
        ...
        jPanel1.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 200, 1360, 570));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewPendingBooks.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewPendingBooks().setVisible(true);
            }
        });
    }
